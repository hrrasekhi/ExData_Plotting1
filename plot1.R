# plot1.R
# Creates plot1.png (480x480) using base R
...
read_power_subset <- function(data_file) {
  ...
  lines <- readLines(con)  # read all remaining lines as text (still lighter than full parsing)
  ...
  # Convert needed numeric columns
